        ...
        return (
            <Marker
                ...
                <Popup>
                    ...
                    <>
                        <h3>Pomoc</h3>
                        {healthInformation.emergencyNumber && <p>Numer alarmowy: {healthInformation.emergencyNumber}</p>}
...
export class MapCoordinate extends React.Component {
    ...
    updateMap = async () => {
        ...
        const response = await axios.get('http://localhost:3001/users/coordinates/all', ConfigApi);
