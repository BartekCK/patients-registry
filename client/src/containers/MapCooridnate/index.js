    ...
    if (id === '-200')
      return (
        <Marker
          icon={userIcon}
          position={[
            coordinateInformation.xCoordinate,
            coordinateInformation.yCoordinate,
          ]}
        >
          <Popup>
            <H4>Cześć, to Ty !</H4>
        ...
        <Popup>
          ...
          {healthInformation && (
            <>
              ...
              {healthInformation.howHelp && (
                <p>Jak pomóc: {healthInformation.howHelp}</p>
              )}
              {healthInformation.notDo && (
                <p>Czego nie robić: {healthInformation.notDo}</p>
              )}
            </>
          )}
        </Popup>
          ...
          {!filters && (
            <>
              <TypeFilter
                ...
                diseasesLocation={diseasesLocation}
              />
              <HelpFilter
                goFilter={goFilter}
                diseasesLocation={diseasesLocation}
